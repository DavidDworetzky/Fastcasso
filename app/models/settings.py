...
class Settings(BaseSettings):
    ...
    #waifu diffusion anime model
    PipelinePreset(model_id="hakurei/waifu-diffusion", inference_steps=50, preset_id=10, default_width=512, default_height=512, negative_keywords="ugly, boring, bad anatomy, deformed face, deformed hands, deformed limbs"),
    #analog diffusion style
    PipelinePreset(model_id="wavymulder/Analog-Diffusion", inference_steps=50, preset_id=11, default_width=512, default_height=512, keywords="analog style", negative_keywords="blur, haze, ugly, boring, bad anatomy, deformed face, deformed hands, deformed limbs")])
